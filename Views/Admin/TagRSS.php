                    ...
                    <form class="form-horizontal form-label-left" action="<?php echo MVC_BASE_URI; ?>/Admin/TagsRSS" method="post" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12"name="rss_tag_name" placeholder="Tên thẻ" required="required" type="text" />
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12"name="tag_dislay_name" placeholder="" required="required" type="text" />
                        </div>
                      </div>
